...
public static Database getDatabase(HashMap<String,String> databaseConfiguration) throws DMFrameworkException
{
...
List<Table> tables=getTables(databaseMetaData,catalog,schema,architecture);
List<View> views=getViews(databaseMetaData,catalog,schema,architecture);
...
static private List<Table> getTables(DatabaseMetaData databaseMetaData,String catalog,String schema,String architecture) throws DMFrameworkException
{
...
{
table=new Table();
table.setName(tablesResultSet.getString("TABLE_NAME").trim());
...
if(column.getType()==java.sql.Types.CHAR && architecture.equalsIgnoreCase("Oracle 11g"))
{
System.out.println("<DatabaseUtility>-<getTables>--<if(column.getType()==java.sql.Types.CHAR && architecture.equals(oracle 11g))--");
...
static private List<View> getViews(DatabaseMetaData databaseMetaData,String catalog,String schema,String architecture) throws DMFrameworkException
{
...
{
view=new View();
view.setName(tablesResultSet.getString("TABLE_NAME").trim());
columnsHashMap=new HashMap<Integer,Column>();
...
property.setName(Utilities.getJavaPropertyName(column.getName()));
column.setType(columnsResultSet.getInt("DATA_TYPE"));
if(column.getType()==java.sql.Types.CHAR && architecture.equals("oracle 11g"))
{
column.applyPadding(true);
}
property.setType(Types.getJavaType(column.getType()));
...
try
{
System.out.println("this is big Decimal : "+string);
