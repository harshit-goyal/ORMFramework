...
/*dataType=new DataType();
dataType.setType(Character.class);
dataType.setPrimitiveType(char.class);
dataType.setSetterGetterMethodName("Char");
dataType.setDefaultValue("\"\"");
*/
...
types.put(java.sql.Types.TIME_WITH_TIMEZONE,dataType);
types.put(java.sql.Types.TIMESTAMP_WITH_TIMEZONE,dataType);


//types.put(java.sql.Types.REAL,);
//types.put(java.sql.Types.TIMESTAMP,);
